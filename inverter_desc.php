        ...
        <div class="row">
          <div class="col-lg-6 product-image" data-aos="fade-right" data-aos-delay="100" style="margin-bottom: 20px;">
            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
              <img src="assets/img/inverter.jpeg" alt="distribution" style="width: 100%; height: auto; margin-bottom: -5px;">
            </div>
          </div>
          <div class="col-lg-6">
                    ...
                    <div class="tab-content" id="myTabContent" style="padding-top: 20px;">
                      <div class="tab-pane fade show active" id="features" role="tabpanel" aria-labelledby="features-tab">
                        ...
                        <ul style="list-style: none; padding: 0;">
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i>Market leader and first manufacturer in India to develop five winding inverter transformers</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i>Passed short circuit test</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i>Low losses</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i>Suitable for solar load profile</li>
                      ...
                      <div class="tab-pane fade" id="specifications" role="tabpanel" aria-labelledby="specifications-tab">
                        ...
                        <table class="table table-bordered" style="color: #555; border:1px;">
                          <tbody>
                            ...
                            <tr>
                              <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">No. of Inverters </th>
                              <td style="font-size: 20px;"> Up to 6 inverters
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td style="font-size: 20px;"> ONAN/ONAF
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td style="font-size: 20px;"> As required
        ...
        <div class="row">
          <div class="col-lg-12">
            <table class="table table-bordered" style="color: #555; border:1px">
              ...
              <tbody>
                <tr>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">Designed to withstand voltage excursions due to pulsed mode inverter operation  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;"></td>

                </tr>
                <tr>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">Inverter Windings are capable to withstand voltage with rate of rise (dV/dt) upto 500V/µs to ground  
                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">
                  </td>
                </tr>
                <tr>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">Galvanically isolated winding for each inverter
                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">
                  </td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Electrostatic shield between inverter and MV winding    
                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">
                  </td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Loosely coupled inverter windings   
                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">
                  </td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Inverter winding could be star/delta. In case of star winding, neutral not to be grounded    
                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">
                  </td>
                </tr>
                <tr>
                  ...
                  <td  style="background-color: #f8f9fa; font-size: 20px;"> Supply segment  

                  </td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;"> Renewable Energy (Solar applications)  
