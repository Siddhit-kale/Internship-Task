        ...
        <div class="row">
          <div class="col-lg-6 product-image" data-aos="fade-right" data-aos-delay="100" style="margin-bottom: 20px;">
            <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
              <img src="assets/img/compact.jpeg" alt="compact Substation" style="width: 100%; height: auto; margin-bottom: -5px;">
            </div>
          </div>
          <div class="col-lg-6">
                    ...
                    <div class="tab-content" id="myTabContent" style="padding-top: 20px;">
                      <div class="tab-pane fade show active" id="features" role="tabpanel" aria-labelledby="features-tab">
                        ...
                        <ul style="list-style: none; padding: 0;">
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i> Lesser footprints than most compact substations</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i> Reduced lead time and faster assembly</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i> Electrically interlocking doors</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i> Improved aesthetics</li>
                          <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i> Ease of inspection and maintenance</li>
                        </ul>
                      </div>
                        ...
                        <table class="table table-bordered" style="color: #555; border:1px;">
                          <tbody>
                            <tr>
                              ...
                              <td style="font-size: 20px;"> Up to 2500 kVA </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">HT Side</th>
                              <td style="font-size: 20px;"> RMU / VCB / Fused Isolators (up to 33kV)</td>
                            </tr>
                            <tr>
                              <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">LT Side
                              </th>
                              <td style="font-size: 20px;">Incomer: ACB / MCCB / SFU <br>Secondary Feeders: ACB / MCCB / SFU / Fuses</td>
                            </tr>
                            <tr>
                              <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">Transformer
                              </th>
                              <td style="font-size: 20px;"> Oil type & Dry Type</td>
                            </tr>
                            <tr>
                              <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">Protection & Metering
                              </th>
        ...
        <div class="row">
          <div class="col-lg-12">
            <table class="table table-bordered" style="color: #555; border:1px">
              ...
              <tbody>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Type tested as per IEC 62271-202 for</td>
                  <td style="font-size: 20px;">Internal Arc Test (20 k Amp for 0.1 sec)<br>
                    IP class (up to IP 54)<br>
                    Temperature rise (K5)<br>
                    Mechanical impact (IK10)<br>
                    Short time current withstand test on inter-connection</td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Inspection windows available as per client requirement</td>
                  <td style="font-size: 20px;">-</td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Interconnection accessibility for maintenance</td>
                  <td style="font-size: 20px;">-</td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">Thermally efficient transformer enclosure</td>
                  <td style="font-size: 20px;">-</td>
                </tr>
                <tr>
                  <td style="background-color: #f8f9fa; font-size: 20px;">1MVA, 11kV CSS footprints: 5.25 sq m</td>
                  <td style="font-size: 20px;">-</td>
                </tr>
                <tr>
