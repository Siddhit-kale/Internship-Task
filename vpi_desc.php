                ...
                <div class="row">
                    <div class="col-lg-6 product-image" data-aos="fade-right" data-aos-delay="100" style="margin-bottom: 20px;">
                        <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                            <img src="assets/img/vpi.jpeg" alt="distribution" style="width: 100%; height: auto; margin-bottom: -5px;">
                        </div>
                    </div>
                    <div class="col-lg-6">
                                        ...
                                        <div class="tab-content" id="myTabContent" style="padding-top: 20px;">
                                            <div class="tab-pane fade show active" id="features" role="tabpanel" aria-labelledby="features-tab">
                                                ...
                                                <ul style="list-style: none; padding: 0;">
                                                    <li style="margin-bottom: 10px; font-size: 20px;"><i class="bi bi-check-circle" style="color: #ff8800; margin-right: 8px; font-size: 24px;"></i>For power, distribution and industrial applications</li>
                                                ...
                                                <table class="table table-bordered" style="color: #555; border:1px;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 20px;">100 kVA to 20 MVA</td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">Voltage Class </th>
                                                            <td style="font-size: 20px;">Up to 22 kV 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 20px;"> OCTL, OCTC, OLTC 
                                                                 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 20px;"> F/H/R 
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row" style="background-color: #f8f9fa; font-size: 20px;">Applicable Standards 
                                                            </th>
                                                            <td style="font-size: 20px;"> IS 11171, IEC 60076-11, IEC / EN 61378, EN  
                                                                 </td>
                                                        </tr>
        ...
        <section class="features-specifications" style="padding-top: 40px;">
            <div class="container" data-aos="fade-up">
                <div class="section-title" style="text-align: left; margin-bottom: 40px;">
                    <h2 style="font-weight: bold; color: #333; font-size: 24px;">Technical Information</h2>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-bordered" style="color: #555; border:1px">
                            ...
                            <tbody>
                                <tr>
                                    <td rowspan="11" scope="row" style="background-color: #f8f9fa; font-size: 20px;">Developed for LV and MV drives for phase shifting winding for 24 and 36 pulse up to 54 pulse.
                                    </td>
                                    <td style="font-size: 20px;"> Three Phase up to 15 MVA
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 20px;"> Special industrial applications like drive control systems and distribution networks with IP54 construction
                                    </td>
                                </tr>
                                <tr>

                                    <td style="font-size: 20px;">Suitable for operations up to 220°C (up to Class R Insulation)
                                    </td>

                                </tr>
                                <tr>

                                    <td style="font-size: 20px;">Multi-winding for industrial environment
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">Special testing transformer for testing of Drives and Inverters
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">Core loop testing transformer for turbo genset
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">Suitable for harmonic loading
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">High current taps for LV winding
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">With or without enclosure 
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 20px;">Infrastructure
                                ...
                                <td rowspan="3" style="background-color: #f8f9fa; font-size: 20px;">Supply segment	</td>
                  <td  style="background-color: #f8f9fa; font-size: 20px;">Industries 	</td>


                                </tr>
                                <tr>
                                <td  style="background-color: #f8f9fa; font-size: 20px;">OEMs</td>
                                </tr>
                                <tr>
                                <td  style="background-color: #f8f9fa; font-size: 20px;">Distribution Network 
                                </td>
                                </tr>
                            </tbody>
                        </table>
